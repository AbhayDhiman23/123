    ...
    <section className="bg-orange-600">
      <footer className="container mx-auto grid grid-cols-10 px-5 py-10 gap-y-10 gap-x-5 md:pt-20 md:grid-cols-12 lg:grid-cols-10 lg:gap-x-10">
        ...
        <div className="col-span-10 md:order-first md:col-span-4 lg:col-span-2">
          ...
          />
          <p className="text-sm text-white text-center mt-4 md:text-left md:text-base lg:text-sm">
            Discover the power of efficient inventory management
          </p>
          <ul className="flex justify-center items-center mt-5 space-x-4 text-white md:justify-start">
            <li>
              <Link to="/">
